...
- [ ] [functional] Add dedicated unit tests for the new _build_check_section helper in agent.py to verify all three branches (cmd+output, cmd-only, no cmd) and ensure the helper is tested independently from the prompt builders
