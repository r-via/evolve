...
- [ ] [functional] [P1] Add cost display to TUI round_header and completion_summary (estimated_cost_usd param), and add Cost Summary table to evolution_report.md per SPEC § "Cost in evolution report" and § "TUI cost display"
