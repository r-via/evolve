...
- [ ] [performance] Reduce code duplication in agent.py by extracting shared agent runner logic from _run_dry_run_claude_agent, _run_validate_claude_agent, and run_claude_agent into a reusable helper, since all three share nearly identical SDK streaming, deduplication, and logging code
