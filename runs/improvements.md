...
- [ ] [functional] [P2] Continue package restructuring step 3: extract git.py from loop.py into evolve/git.py (self-contained git operations — _ensure_git, _git_commit, _git_push, branch management), update imports, add backward-compat shim at root
