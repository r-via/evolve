...
- [ ] [functional] Add auto-detection of test framework when --check is omitted: scan project for pytest, npm test, cargo test, go test, make test and use the first found, as described in the README's "--check flag" section
