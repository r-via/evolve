...
- [ ] [functional] Implement auto-detection of test framework when --check is omitted — README says evolve should look for pytest, npm test, cargo test, go test, make test and use the first found
