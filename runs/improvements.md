...
- [ ] [performance] Extract duplicated README/improvements loading logic from build_prompt, build_validate_prompt, and build_dry_run_prompt into a shared _load_project_context helper to reduce repetition and centralize file-loading logic
